...
- [Knowledge graph (graphify)](development/graphify.md) — the committed `graphify-out/` map of the codebase: how to install the CLI, the team commit-and-pull workflow, and how to query it instead of grepping.
