...
For the fastest path, use the [devcontainer](../../.devcontainer/README.md) — it pins Python, installs uv and pre-commit, and gives you a Claude Code setup with a default-deny egress firewall. The rest of this page assumes you're setting up directly on your host.
...
Make a branch off `main` for any non-trivial work (see [Project workflow](../../AGENTS.md#workflow)).
...
- [API overview](../api/README.md) — endpoints and request shapes
