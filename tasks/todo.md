...
- [x] 1. Prep: move spec to `docs/specs/guard-auto-deploy-on-publish.md`; commit plan + spec move
...
- [x] 4. Gate auto-staging-on-publish
...
- [x] 5. Gate docs.yaml release deploy
